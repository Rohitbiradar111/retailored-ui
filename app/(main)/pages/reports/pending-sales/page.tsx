                                ...
                                <div className="flex flex-column gap-2">
                                    <div className="flex align-items-center gap-2">
                                        <div style={{ border: '2px solid blue', borderRadius: '10px', padding: '25px 2px', backgroundColor: 'lightgray' }}>
                                            <Image src={item.customerName} alt={item.customerName} width="80" />
                                        </div>
                                        <div>
                                            ...
                                            <div>Order No: {item.order_id}</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-column gap-1">
                                        <div className="flex justify-content-between">
                                            <div>
                                                <span className="pi pi-shopping-bag mr-1"></span>
                                                <span>{item.productName}</span>
                                            </div>
                                            <Tag
                                                value={item.jobOrderStatus.length > 0 ? item.jobOrderStatus[0].status_name : 'Pending'}
                                                severity={getStatusSeverity(item.jobOrderStatus.length > 0 ? item.jobOrderStatus[0].status_name : 'Pending')}
                                                style={{ border: '1px solid black', backgroundColor: 'lightgray', color: 'black' }}
                                            />
                                        </div>
                                        <div className="flex justify-content-between">
                                            <div>
                                                <span className="pi pi-calendar mr-1"></span>
                                                <span className="text-600 mr-1">Trial:</span>
                                                <span>N/A</span>
                                            </div>
                                            <div>
                                                <span className="pi pi-calendar mr-1"></span>
                                                <span className="text-600 mr-1">Delivery:</span>
                                                <span>{item.deliveryDate ? formatDate(item.deliveryDate) : 'Not scheduled'}</span>
                                            </div>
                                        </div>
                                        <div className="flex">
                                            <span className="pi pi-clock mr-1"></span>
                                            <span className="text-600 mr-1">Received:</span>
                                    ...
                                    <div
                                        ...
                                        style={{ userSelect: 'none', border: '1px solid blue', borderRadius: '20px', padding: '5px', textAlign: 'center' }}
                                    >
                                        Long Press to view more Details
                                        <Dialog visible={visible} onHide={() => setVisible(false)} style={{ width: '90vw', maxWidth: '500px' }} breakpoints={{ '960px': '75vw', '641px': '100vw' }}>
